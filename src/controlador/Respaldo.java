...
public class Respaldo implements ActionListener {
    ...
    public void backUp() {
        try {
            int processCompleto;
            Process p = Runtime.getRuntime().exec("C:/Program Files (x86)/MariaDB 10.5/bin/mysqldump.exe -u root -p19199697tsoCD cdstore");
            ...
            JOptionPane.showMessageDialog(null, e + "Al intental hacer el respaldo.");
        }
    }
